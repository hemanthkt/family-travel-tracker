...
app.post("/user", async (req, res) => {
  ...
  //     "SELECT users.color FROM users JOIN visited_countries ON users.id = visited_countries.user_id WHERE visited_countries.user_id = $1",
  //     [userId]
  //   );

  //   // Check if a color was found
  //   const color = colorResult.rows[0] ? colorResult.rows[0].color : null;
